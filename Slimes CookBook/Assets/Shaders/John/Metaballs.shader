Shader "Universal Render Pipeline/Custom/Metaballs"
{
    ...
    Properties
    {
        ...
        _Collision("Collision Point", Vector) = (0,0,0)
        _Test("Test Point", Vector) = (0,0,0)
        _Number("Balls Num", Int) = 0
        ...
        SubShader
    {
        ...
        #include "MetaballsHelper.hlsl"
        #include "MetabbalsForward.hlsl"
        ENDHLSL
    }
