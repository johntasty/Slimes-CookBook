			...
			HLSLINCLUDE
					...
					Stencil
				{
					...
					SurfaceData InitializeSurfaceData(Varyings IN) {
						...
						half4 albedoAlpha = SampleAlbedoAlpha(IN.uv, TEXTURE2D_ARGS(_DissolveTex, sampler_DissolveTex));
						half dissolve = SampleAlbedoAlpha(IN.uv, TEXTURE2D_ARGS(_DissolveTex, sampler_DissolveTex)).r;
