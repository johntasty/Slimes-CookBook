...
inline void InitializeStandardLitSurfaceDataFor(float2 uv, out SurfaceData outSurfaceData, float4 view, float3 positionWs)
{
    ...
    outSurfaceData.emission = outSurfaceData.emission + glow;
...
half4 LitPassFragment(Varyings input) : SV_Target
{
    ...
    InitializeStandardLitSurfaceDataFor(input.uv, surfaceData, input.viewDis, input.positionWS);
